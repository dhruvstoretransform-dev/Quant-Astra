...
function About() {
  ...
  useEffect(() => {
    ...
    function animateValue(start, end, duration, setter, decimal = false) {
      let startTime = null;
    ...
    function startAnimation() {
      animateValue(0, 99.9, 2500, setLogic, true);
      animateValue(0, 60, 2500, setRecovery, false);
    }
  ...
  return (
    <section className="aboutjsx-about" ref={sectionRef}>
